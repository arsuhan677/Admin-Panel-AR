...
function Sidebar() {
  ...
  const menuItems = [
    ...
    { id: 2, label: "User", icon: User, badge: "3", path: "/profile" },
    {
      id: 3,
      label: "E-commerce",
      icon: ShoppingCart,
    ...
    { id: 4, label: "Inventory", icon: Package, badge: "", path: "/inventory" },
    { id: 5, label: "Message", icon: MessageSquare, badge: "", path: "/messages" },
